...
import wave
import time
from wake_word import porcupine, stream  # Import wake-word detector from wake_word.py
...
CHANNELS = 1
RATE = 16000
RECORD_SECONDS = 5  # Record 5 seconds after wake word
...
def listen_for_command():
    ...
    while True:
        ...
        if result >= 0:
            ...
            time.sleep(1)  # Avoid rapid re-trigger
